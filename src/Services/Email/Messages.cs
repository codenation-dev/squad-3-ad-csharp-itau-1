namespace TryLog.Services.Email
{
    public static class Messages
    {
        ...
        "</h4>Your password was successfully changed.<br><br><table><tbody>" +
            ...
            "<tr><td>Created </td><td>{2}</td></tr>" + Footer;
        ...
        " your email address is correct.</td></tr>" + Footer;
        ...
        "to proceed with reactivation.</td></tr>" + Footer;
        ...
        public static string PasswordResetConfirmation =
            ...
            + "<tr><td>Created</td><td>{3}</td></tr>" + Footer;

        private static readonly string Footer = "</tbody></table></td></tr><tr><td colspan = '3' height= '20'></td></tr><tr><td colspan= '3' " +
